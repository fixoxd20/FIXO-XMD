...
async function connectToWA() {
  console.log("Connecting 𝗙𝗜𝗫𝗢 𝗫𝗠𝗗");
...
╠═════════════════╣
║   𝗙𝗜𝗫𝗢 𝗫𝗠𝗗               
║ > © ᴘᴏᴡᴇʀᴇᴅ ʙʏ FIXO X 〽️D        
╚═════════════════╝`;

        const up1 = `Hello Mr FIXO XD i succesfully deployed FIXO XMD`;
  ...
  robin.ev.on("messages.upsert", async (mek) => {
    ...
    if (senderNumber.includes("94711767300") && !isReact) {
      m.react("🔓");
    }
